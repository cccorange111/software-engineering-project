...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (1, 'admin', '$2a$10$u1QkciXh6Ym9aoS0HBDOpuJYP27XD.xUhYV3oN2ESHdX//uSQocfS', 'abbcfc42-b1d9-45f7-9a55-24b80cee4a12');
INSERT INTO `admin` VALUES (2, 'new_admin', '$2a$10$u1QkciXh6Ym9aoS0HBDOpuJYP27XD.xUhYV3oN2ESHdX//uSQocfS', 'abbcfc42-b1d9-45f7-9a55-24b80cee4a12');
...
CREATE TABLE `comments`  (
  ...
  `article_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
-- Records of comments
-- ----------------------------
INSERT INTO `comments` VALUES (1234567, '你好','admin','admin','2024.1.1');
INSERT INTO `comments` VALUES (1234568, '请问可以评论吗','admin','admin','2024.1.1');
INSERT INTO `comments` VALUES (1234569, 'hello','hello_world','admin','2024.1.1');
INSERT INTO `comments` VALUES (1234560, '沙发','admin','admin','2024.1.1');
INSERT INTO `comments` VALUES (1234561, 'so fast','admin','admin','2024.1.1');
INSERT INTO `comments` VALUES (1234562, '第一','admin','admin','2024.1.1');
